...
if st.button("Bootstrap计算"):
    ...
    ax.axvline(ci_low, color="orange", ls="--", lw=1.5, label=f"90%CI lower limit={ci_low:.2f}")
    ax.axvline(ci_high, color="orange", ls="--", lw=1.5, label=f"90%CI upper limit={ci_high:.2f}")
